                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {[
                            ...
                            { label: 'Pending', val: earnings?.pending || '0.00', icon: FaClock, color: 'text-orange-500', bg: 'bg-orange-50' },
                            { label: 'Approved', val: earnings?.approved || '0.00', icon: FaArrowUp, color: 'text-blue-500', bg: 'bg-blue-50' },
                        ].map((item, i) => (
                            <div key={i} className={`${item.bg} rounded-3xl p-6 border border-white/50 shadow-sm`}>
