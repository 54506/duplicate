...
export default function Earnings() {
  ...
  // Revenue should only reflect actual sales transactions.
  // Setting to 0 for now as order placement logic is pending.
  ...
  // Transactions should reflect actual sales. Setting to empty for now.
  const transactions = [];
