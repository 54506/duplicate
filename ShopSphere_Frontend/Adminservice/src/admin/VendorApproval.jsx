...
const VendorApproval = () => {
    ...
    const getVendorStatus = (vendor) => {
        ...
        return vendor.approval_status.charAt(0).toUpperCase() + vendor.approval_status.slice(1);
    };

    const getStatusColor = (vendor) => {
        if (vendor.is_blocked) return 'text-rose-500 bg-rose-50 border-rose-100/50';
        switch (vendor.approval_status?.toLowerCase()) {
            ...
            case 'rejected': return 'text-rose-400 bg-rose-50 border-rose-100/40';
