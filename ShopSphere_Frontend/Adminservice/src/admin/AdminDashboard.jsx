...
import { Store, ShoppingCart, PanelLeftClose, PanelLeftOpen, ClipboardList, Users } from 'lucide-react';
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <button
                                ...
                                className="bg-gradient-to-r from-emerald-500 to-emerald-900 hover:from-emerald-700 hover:to-emerald-800 text-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center gap-3 font-semibold text-lg"
                            >
                                <ClipboardList className="w-6 h-6" />
                                JOIN REQUESTS
                            </button>
